...
import pdb
import numpy as np
from AaltoAtoms import scattering_simulation as ss
from AaltoAtoms import args
...
if __name__=="__main__":
	...
	args = args.get_args(argparse.ArgumentParser())
	...
	ssim.simulate_and_save_line_spectrum(n_spectra=5, n_bias=5)
	exit(0)
