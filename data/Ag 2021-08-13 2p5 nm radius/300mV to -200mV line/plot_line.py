...
import os
p = "/Users/akipnis/Desktop/Aalto Atomic Scale Physics/Summer 2021 Corrals Exp data/Ag 2021-08-13 2p5 nm radius/300mV to -200mV line/"
image = createc.DAT_IMG("/Users/akipnis/Desktop/Aalto Atomic Scale Physics/Summer 2021 Corrals Exp data/Ag 2021-08-13 2p5 nm radius/300mV to -200mV line/Createc2_210813.231030.dat")
...
specs[0].__dict__['bias_mv'][0]
specs[0].__dict__['fname']

image.__dict__['ch_bias']
...
im1 = ax1.matshow(np.array(dIdVs).T,extent=[0,dist/10.,-200,300], aspect="auto",cmap=plt.get_cmap("plasma")) #making aspect larger makes image skinnier
ax1.set_xlabel("nm")
...
# plt.show()
plt.savefig("/Users/akipnis/Desktop/Createc2_210813.231030_2p5nm_500mV.pdf")
# image.offset[0]/10
