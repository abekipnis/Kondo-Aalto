...
import os
p = "/Users/akipnis/Desktop/Aalto Atomic Scale Physics/Summer 2021 Corrals Exp data/Ag 2021-07-29 corral built/Line spectrum across corral/"
image = createc.DAT_IMG("/Users/akipnis/Desktop/Aalto Atomic Scale Physics/Summer 2021 Corrals Exp data/Ag 2021-07-21 angle sputtering/Createc2_210729.175631.dat")
image.__dict__['bias']
...
# np.round(min(specs[0].__dict__['bias_mv']),0)
specs[0].__dict__.keys()


specs[0].__dict__['LockinAmpl']
specs[0].__dict__['LockinFreq']
specs[0].__dict__['FBLogiset']
specs[0].__dict__['biasVoltage']
specs[0].__dict__['bias_offset']
...
# plt.show()
plt.savefig("/Users/akipnis/Desktop/Createc2_210729.175631_2p5nm_pm100mV.pdf")
# image.offset[0]/10
