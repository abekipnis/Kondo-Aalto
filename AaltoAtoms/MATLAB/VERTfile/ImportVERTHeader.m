...
if STMAFMVersion == 4
    ...
    Header.ChannelList = str2double(Info{5}); % Sum of binary channel values, see help
    ...
    Header.XPos_nm = str2double(Info{9}); % Spec X-coordinate in the approach area
    Header.YPos_nm = str2double(Info{10}); % Spec Y-coordinate in the approach area
end
fclose(fid);
