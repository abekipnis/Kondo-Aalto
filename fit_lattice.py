...
spectrum = scattering_model.get_spectra(atompoints/100, 30, 4, erange) #radius doesn't matter much here, just has to be larger than the radius of the actual atoms (can hard code this, given we have c.r)
pdb.set_trace()
